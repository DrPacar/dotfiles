  ...
  in
    lib.flatten (lib.mapAttrsToList (
        ...
        in
          ...
          then getModulesRec fullItemPath
          else []
      )
      validEntries);
in
  root: baseDir: path: let
  ...
  in
    ...
    else if builtins.pathExists fullPath
    then getModulesRec fullPath
    else throw "Module path '${baseDir}/${path}' does not exist!"
